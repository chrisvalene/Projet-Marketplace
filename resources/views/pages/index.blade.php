...
@section('content')
    ...
    <section id="hero" class="hero">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-10">
            <p data-aos="fade-up" data-aos-delay="200">Rechercher les marchés disponibles pour une commande plus rapide et fiable</p>
          </div>
          <div class="col-lg-5">
    ...
    <section id="contact" class="contact">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Contact</h2>
        <p>Pour plus d'informations, veuillez laisser un message</p>
      </div><!-- End Section Title -->
            ...
            <form action="forms/contact.php" method="post" class="php-email-form" data-aos="fade-up" data-aos-delay="200">
              <div class="row gy-4">
                ...
                <div class="col-md-12 text-center">
                  ...
                  <div class="sent-message">Envoyez votre message</div>
