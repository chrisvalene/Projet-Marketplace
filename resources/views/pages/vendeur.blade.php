       ...
       <div class="modal fade" id="ajou" tabindex="-1">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
							   <form action="{{route('vendeur.store')}}" class="row g-4" method="post" enctype="multipart/form-data">
                     @csrf      
                  <div class="col-md-12 mb-4">
                                    <input type="text" class="form-control" placeholder="Nom user" name="nom">
                                </div>
                                ...
                                <div class="col-md-12 mb-4">
                                 <input type="number" class="form-control" placeholder="Votre numero de téléphone" name="telephone">
                                </div>
                                ...
                                <div class="col-md-12">
                                  <select name="marche_id" id="" class="form-control">
