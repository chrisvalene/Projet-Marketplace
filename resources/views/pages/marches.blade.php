       ...
       <div class="modal fade" id="ajou" tabindex="-1">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
							   <form action="{{route('marches.store')}}" class="row g-4" method="post" enctype="multipart/form-data">
                                  @csrf
                                <div class="col-md-12 mb-4">
                                    <input type="text" class="form-control" placeholder="Nom marché" name="nom">
                                </div>
                                <div class="col-md-12 mb-4">
                                    <input type="text" class="form-control" placeholder="adresse du marché" name="adresse">
                                </div>
